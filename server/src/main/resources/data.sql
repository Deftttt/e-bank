...
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 3, '728119146', 'client3@example.com', 'Piotr', 'Stasicki', '$2a$10$aCGR0e3BrvkMWkerE3/e.Oz1fPkgXHxHEjx2o/Oid0HDs6EQrkHsW', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 4, '889381290', 'client4@example.com', 'Kong', 'Strong', '$2a$10$Aa43f50LIn969ld23dql3exLgA20ZuwKmJewH/zHhizQAjFw0yXYG', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 5, '889381291', 'client5@example.com', 'Kong2', 'Strong2', '$2a$10$tm72W9mUdtNU3f5TZE578ea87FZI8v7NXcJv90SJrlJ0x1lq8tjMy', null);
...
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 101, '999111000', 'employee@example.com', 'Agnieszka', 'Szczepańska', '$2a$10$e8MrlEmtAiy0hKc/zrniX.IRt1zGt65ja5S5L0iE6PEuNgeSzCsn6', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 102, '999111022', 'employee2@example.com', 'Barbara', 'Kamińska', '$2a$10$mgfaIlZVVAuyXY5eiDcHF.b0wq0hNsFLcmWPzBvjlES4sT1gYrzdK', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 103, '999111088', 'employee3@example.com', 'Tomasz', 'Mazur', '$2a$10$jMXqW.a66biTNdQTDrAsjOlwyva9tTPeZLPnMi9fWiiAlsUTy3Ane', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 104, '999111055', 'employee4@example.com', 'Kamil', 'Szczęsny', '$2a$10$jMXqW.a66biTNdQTDrAsjOlwyva9tTPeZLPnMi9fWiiAlsUTy3Ane', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 105, '999111066', 'employee5@example.com', 'Mariusz', 'Lewandowski', '$2a$10$jMXqW.a66biTNdQTDrAsjOlwyva9tTPeZLPnMi9fWiiAlsUTy3Ane', null);
INSERT INTO user (enabled, mfa_enabled, id, phone_number, email, first_name, last_name, password, secret) VALUES (true, false, 106, '999111077', 'employee6@example.com', 'Piotr', 'Stasicki', '$2a$10$jMXqW.a66biTNdQTDrAsjOlwyva9tTPeZLPnMi9fWiiAlsUTy3Ane', null);


INSERT INTO _right (id, name) VALUES (1, 'VIEW_CLIENTS');
INSERT INTO _right (id, name) VALUES (2, 'EDIT_CLIENTS');
INSERT INTO _right (id, name) VALUES (3, 'VIEW_EMPLOYEES');
INSERT INTO _right (id, name) VALUES (4, 'EDIT_EMPLOYEES');
INSERT INTO _right (id, name) VALUES (5, 'VIEW_ACCOUNTS');
INSERT INTO _right (id, name) VALUES (6, 'MANAGE_ACCOUNTS');
INSERT INTO _right (id, name) VALUES (7, 'VIEW_LOANS');
INSERT INTO _right (id, name) VALUES (8, 'APPROVE_LOANS');
INSERT INTO _right (id, name) VALUES (9, 'EMPLOYEE_RIGHTS');
INSERT INTO _right (id, name) VALUES (10, 'USER_RIGHTS');
INSERT INTO _right (id, name) VALUES (11, 'VIEW_DEPOSITS');
INSERT INTO _right (id, name) VALUES (12, 'VIEW_TRANSACTIONS');

INSERT INTO position (salary, id, position_name) VALUES (7400, 1, 'Loan Analyst');
INSERT INTO position (salary, id, position_name) VALUES (6600, 2, 'Client Support');
INSERT INTO position (salary, id, position_name) VALUES (15000, 3, 'Branch Manager');
...
INSERT INTO position_rights (_right_id, position_id) VALUES (2, 2);
INSERT INTO position_rights (_right_id, position_id) VALUES (5, 2);
INSERT INTO position_rights (_right_id, position_id) VALUES (6, 2);
INSERT INTO position_rights (_right_id, position_id) VALUES (12, 2);

INSERT INTO position_rights (_right_id, position_id) VALUES (1, 3);
INSERT INTO position_rights (_right_id, position_id) VALUES (3, 3);
INSERT INTO position_rights (_right_id, position_id) VALUES (4, 3);
...
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (15, 101, '89', '00-001', 'Warszawa', 'Polska', '3 maja');
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (16, 102, '8H', '00-008', 'Lublin', 'Polska', 'Lubartowska');
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (17, 103, '9I', '00-009', 'Katowice', 'Polska', 'Stawowa');
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (18, 104, '10J', '00-010', 'Białystok', 'Polska', 'Lipowa');
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (19, 105, '11K', '00-011', 'Rzeszów', 'Polska', 'Krakowska');
INSERT INTO address (id, user_id, local_number, post_code, city, country, street) VALUES (20, 106, '12L', '00-012', 'Przemyśl', 'Polska', 'Warszawska');


INSERT INTO employee (id, position_id, department) VALUES (101, 2, 'Customer Service');
INSERT INTO employee (id, position_id, department) VALUES (102, 2, 'Customer Service');
INSERT INTO employee (id, position_id, department) VALUES (103, 2, 'Customer Service');
INSERT INTO employee (id, position_id, department) VALUES (104, 1, 'Loans and Credits');
INSERT INTO employee (id, position_id, department) VALUES (105, 1, 'Loans and Credits');
INSERT INTO employee (id, position_id, department) VALUES (106, 3, 'Administration');

INSERT INTO client (id, pesel) VALUES (1, '89123458901');
INSERT INTO client (id, pesel) VALUES (2, '02779856702');
INSERT INTO client (id, pesel) VALUES (3, '12345678901');
INSERT INTO client (id, pesel) VALUES (4, '22345678902');
INSERT INTO client (id, pesel) VALUES (5, '32345678903');
INSERT INTO client (id, pesel) VALUES (6, '42345678904');
INSERT INTO client (id, pesel) VALUES (7, '52345678905');
INSERT INTO client (id, pesel) VALUES (8, '62345678906');
INSERT INTO client (id, pesel) VALUES (9, '72345678907');
INSERT INTO client (id, pesel) VALUES (10, '82345678908');
INSERT INTO client (id, pesel) VALUES (11, '92345678909');
INSERT INTO client (id, pesel) VALUES (12, '02345678900');
