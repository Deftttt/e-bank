    ...
    const isEmployee = auth?.roles?.includes('VIEW_LOANS');
            ...
            <Grid container spacing={3} mt={4} justifyContent="center">
                ...
                <>
                    ...
                    <Card elevation={3} sx={{ boxShadow: 3 }}>
                        ...
                        <Typography variant="body2" component="div">
                            View all loans in the bank.
                        </Typography>
                        <Box mt={2}>
                            <Button variant="contained" color="primary" fullWidth onClick={() => handleNavigation(`/loans`)}>
                            Go to Loans
                            </Button>
                        </Box>
                        </CardContent>
