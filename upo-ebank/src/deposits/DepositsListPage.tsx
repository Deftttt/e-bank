    ...
    import { DepositStatus, getAllTimeDeposits, getTimeDepositsByAccountNumber, getTimeDepositsByClientId } from "./services/DepositsService";
        ...
        useEffect(() => {
            const fetchDeposits = async () => {
                ...
                try {
                    ...
                    if (clientId) {
                        data = await getTimeDepositsByClientId(clientId, page, rowsPerPage, sort);
            ...
            fetchDeposits();
        }, [navigate, page, rowsPerPage, sort, status, accountNumber, clientId]);
            ...
            return (
                <>
                    <Container maxWidth={false}>
                        <h1>
                            {accountNumber ? `Deposits for account ${accountNumber}:` : clientId ? `Deposits for client ${clientId}:` : 'List of all deposits:'}
                        </h1>
